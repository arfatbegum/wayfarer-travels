        ...
        <div className="flex flex-col">
            <div className="relative h-full border-2 bg-white border-gray-200 border-opacity-60 rounded-lg overflow-hidden shadow-sm">
                <Image
                    ...
                    className="rounded rounded-b-none h-[300px]"
                />
                <span
                ...
                <div className="px-6 pb-6 pt-4">
                    <div className="flex justify-between items-center mb-2">
                        <div className="flex items-center gap-1 mt-1">
                            ...
                            <span className="text-md text-[#0f337a]"> {news?.contentType}</span>
                        </div>
                    ...
                    <h1 className="title-font text-lg font-bold text-gray-900 mb-3">{news?.title}</h1>
