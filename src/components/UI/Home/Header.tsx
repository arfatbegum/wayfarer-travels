    ...
    return (
        <div>
            ...
            <section className="relative py-32 lg:py-36 bg-white">
                <div
                    ...
                    <div className="absolute w-full lg:w-1/2 inset-y-0 lg:right-0 hidden lg:block">
                        ...
                        <span className="absolute right-4 bottom-12 w-24 h-24 rounded-3xl bg-[#13357b] blur-xl opacity-80"></span>
                    </div>
                    <span
                        className="w-4/12 lg:w-2/12 aspect-square bg-gradient-to-tr from-[#13357b] to-violet-400 absolute -top-5 lg:left-0 rounded-full skew-y-12 blur-2xl opacity-40 skew-x-12 rotate-90"></span>
            ...
            font-bold text-gray-900">
                            Embark on <span
                                className="text-transparent bg-clip-text bg-gradient-to-br from-indigo-600 from-20% via-[#13357b] via-30% to-[#13357b]">Unforgettable </span>
                        ...
                        <div className="mt-10  w-full flex max-w-md mx-auto lg:mx-0">
                            <div className="flex sm:flex-row flex-col gap-5 w-full">
                                ...
                                after:absolute after:inset-x-0 after:aspect-square after:scale-0 after:opacity-70 after:origin-center after:duration-300 after:ease-linear after:rounded-full after:top-0 after:left-0 after:bg-[#172554] hover:after:opacity-100 hover:after:scale-[2.5] bg-[#13357b] border-transparent hover:border-[#172554]">
