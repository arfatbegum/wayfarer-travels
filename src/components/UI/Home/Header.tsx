            ...
            <section className="relative py-32 lg:py-36 bg-white">
                <div
                    ...
                    <div className="absolute w-full lg:w-1/2 inset-y-0 lg:right-0 hidden lg:block">
                        ...
                        <span className="absolute right-4 bottom-12 w-24 h-24 rounded-3xl bg-[#0f337a] blur-xl opacity-80"></span>
                    </div>
                    <span
                        className="w-4/12 lg:w-2/12 aspect-square bg-gradient-to-tr from-[#0f337a] to-violet-400 absolute -top-5 lg:left-0 rounded-full skew-y-12 blur-2xl opacity-40 skew-x-12 rotate-90"></span>
