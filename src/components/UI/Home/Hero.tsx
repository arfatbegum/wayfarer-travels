        ...
        <div>
            ...
            <div className="mx-auto container lg:pt-20">
                <div className="relative">
                    <Image  quality={100} width={500} height={400} src={banner} alt="" className="w-full h-full object-center object-fill absolute block" />
                    <div className="text-xl relative z-20 bg-gradient-to-r from-[#0f337a] to-transparent w-full h-full top-0 lg:px-16 lg:pt-36 lg:pb-56 p-6 flex flex-col justify-between">
                        <div>
                        ...
                        <div className="md:mt-12 lg:mt-20 mt-6">
