...
const Banner = () => {
    return (
        <div className="mx-auto container lg:p-10 p-4">
            <div className="relative rounded-md">
                <Image quality={100} width={500} height={200} src="https://i.ibb.co/CpcTvnk/0x0.jpg" alt="" className="w-full h-full rounded-md  object-center object-fill absolute sm:block" />
